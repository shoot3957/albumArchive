...
CREATE TABLE album (
    ...
    name VARCHAR(50) NOT NULL, -- 앨범 이름
 	artist_id CHAR(36) NOT NULL, -- 아티스트 번호 (참고: artist 테이블의 id와 연결하려면 수정 필요)
...
CREATE TABLE cart (
    ...
    album_id VARCHAR(50) NOT NULL, -- 앨범 이름
    user_id VARCHAR(20) NOT NULL, -- 회원 ID
    price INT NOT NULL, -- 가격
    qty INT NOT NULL -- 수량
);
...
INSERT INTO album (id, name, artist_id, info, price, likes, total_qty, category, dates) VALUES
('1Yo63a5AzPMyHiYMKYIrld','Dynamite', '3Nrfpe0tUJi4K4DXYWgMUX', 'BTS의 대표 앨범', 25000, 150, 500, 'K-POP', '2020-08-21'),
('2gNPnKP1PDkB5SZz3IMKuX','The Album', '41MozSoPIsD1dJM0CLPjZF', 'BLACKPINK 첫 정규 앨범', 30000, 200, 300, 'K-POP', '2020-10-02'),
('2xEH7SRzJq7LgA0fCtTlxH', 'Love Poem', '3HqSLMAZ3g3d5poNaI7GOU', 'IU 감성 앨범', 20000, 120, 400, 'Ballad', '2019-11-01');
...
INSERT INTO cart (num, album_id, user_id, price, qty) VALUES
(1, '1Yo63a5AzPMyHiYMKYIrld', 'user1', 25000, 2),
(2,'2gNPnKP1PDkB5SZz3IMKuX', 'user2', 30000, 1),
(3, '2xEH7SRzJq7LgA0fCtTlxH', 'user3', 20000, 3);

INSERT INTO likes (num, album_id, name) VALUES
(1, '1Yo63a5AzPMyHiYMKYIrld', 'user1'),
(2, '2gNPnKP1PDkB5SZz3IMKuX', 'user2'),
(3, '2xEH7SRzJq7LgA0fCtTlxH', 'user3');

INSERT INTO purchase (num, album_id, user_id, total_price, dday,total_qty) VALUES
(1, '1Yo63a5AzPMyHiYMKYIrld', 'user1', 50000, '2025-03-15',2),
(2, '2gNPnKP1PDkB5SZz3IMKuX', 'user2', 30000, '2025-03-16',1),
(3, '2xEH7SRzJq7LgA0fCtTlxH', 'user3', 60000, '2025-03-17',3);
...
INSERT INTO review (num, info, user_id, album_id, title) VALUES
(1, '정말 좋은 앨범이에요!', 'user1', '1Yo63a5AzPMyHiYMKYIrld', '최고의 앨범'),
(2, '노래가 너무 좋아요', 'user2', '2gNPnKP1PDkB5SZz3IMKuX', '강추!'),
(3, '감성적인 앨범', 'user3', '2xEH7SRzJq7LgA0fCtTlxH', 'IU 최고');

INSERT INTO song (id, album_id, name) VALUES
('72IwoG8tqvIWV10IHjpNNA', '1Yo63a5AzPMyHiYMKYIrld', 'Dynamite'),
('2klid0zSCvIkOjXa0EKbVd', '1Yo63a5AzPMyHiYMKYIrld', 'Life Goes On'),
('6bvZRLLkBKkmgpBJTTj3QK', '2gNPnKP1PDkB5SZz3IMKuX', 'How You Like That'),
('1GMufNnkKAnPLnqKJ5HHxW', '2gNPnKP1PDkB5SZz3IMKuX', 'Lovesick Girls'),
('28tufPkTcXmdNqTvi9hsoG', '2gNPnKP1PDkB5SZz3IMKuX', 'Pretty Savage'),
('7HrE6HtYNBbGqp5GmHbFV0', '2xEH7SRzJq7LgA0fCtTlxH', 'Love Poem'),
('3h7WIL3B6nP3171zl6HWj8', '2xEH7SRzJq7LgA0fCtTlxH', 'Jam Jam'),
('4Dr2hJ3EnVh2Aaot6fRwDO', '2xEH7SRzJq7LgA0fCtTlxH', 'Blueming');
