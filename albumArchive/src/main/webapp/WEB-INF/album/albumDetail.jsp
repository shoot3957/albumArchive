...
<style>
/* 기존 스타일 */
.like-button { cursor: pointer; font-size: 24px; display: inline-block; margin-left: 5px; }
.liked { color: red; }
.album-details { margin-top: 20px; }
.buttons { margin-top: 10px; }
.btn { padding: 5px 10px; margin-right: 5px; }
.tab-container { margin-top: 20px; }
.tab-list { display: flex; border-bottom: 2px solid #000; margin-bottom: 20px; }
.tab { padding: 10px 20px; cursor: pointer; font-weight: bold; }
.tab.active { border-bottom: 3px solid #000; }
.tab-content { display: none; padding: 20px; background-color: #f9f9f9; border-radius: 10px; }
.tab-content.active { display: block; }
.review-form { margin-top: 20px; }
.review-list { margin-top: 20px; }
.review-item { border-bottom: 1px solid #ccc; padding: 10px 0; position: relative; }
.review-actions { position: absolute; right: 10px; top: 10px; }
.review-actions a { margin-left: 5px; text-decoration: none; color: #007bff; }
            ...
            <div id="editModal" class="modal">
                <div class="modal-content">
                    ...
                    <form id="editForm" action="/albumArchive/adminAlbumUpdate.do" method="post">
                        ...
                        <div>
                            <label>가격:</label>
                            <input type="number" name="price" value="${album.price}" min="0" required>
                        </div>
                        <div>
                            <label>재고 수량:</label>
                            <input type="number" name="totalQty" value="${album.totalQty}" min="0" required>
                        </div>
                        <div>
                            <label>좋아요 수:</label>
